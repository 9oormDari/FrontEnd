...
const HeatmapComponent: React.FC = () => {
  ...
  useEffect(() => {
    fetch(`https://gist.githubusercontent.com/karpitony/11107c6596e5e5fa8f5ec9c501e54d4d/raw/98899699ee3e981b47b42aa7d5e12864b3921bd8/data.json`)
  ...
  return (
    <div>
      <CalHeatmapDisplay data={typedJsonData} /> {/* 데이터를 props로 전달 */}
    </div>
  );
};
