...
const Calendar: React.FC = () => {
  ...
  const [dayAchieveMap, setDayAchieveMap] = useState<Map<string, number>>(new Map());
    ...
    const fetchCalendar = async () => {
      ...
      try {
        ...
        if (response.status === 'OK' && response.data) {
          const dayAchieveList: DayAchieve[] = response.data.dayAchiveList;
          ...
          setError(response.description || '캘린더 데이터를 불러오는 데 실패했습니다.');
        }
      } catch (err: any) {
